...
export const listingCardContentClass =
  "listing-card-shell__content relative z-[1] flex flex-col h-full min-h-0 pointer-events-none";
export const listingCardActionsClass =
  "listing-card-shell__actions relative z-[2] pointer-events-auto";
